...
public class MyVideoHotXrecycleView extends XRecyclerView.Adapter<MyVideoHotXrecycleView.MyViewHoolder> {
   private List<UserVideoBean.DataBean> list;
   private Context context;
   private List<Integer> heightList;

    public MyVideoHotXrecycleView(List<UserVideoBean.DataBean> list, Context context ) {
        this.list = list;
